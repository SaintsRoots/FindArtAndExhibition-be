...
import { createUser, deleteUser, getAllUsers, getOneUser, login, updateUser, forgotPassword, resetPassword, approveStatus, approveAdminStatus, cancelArtistRequest } from "../controllers/users.controller";
...
userRoute.post("/:id/cancel", fileUpload.single("files"), cancelArtistRequest);
